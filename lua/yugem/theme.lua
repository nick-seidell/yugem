...
function M.get(config)
  ...
  theme = {
    ...
    BufferLineWarningSelected = { fg = p.color100, bg = p.color700, style = 'italic' },
    BufferLineErrorSelected = { fg = p.color100, bg = p.color700, style = 'italic' },
    BufferLineHint = { fg = p.color600, bg = p.color800 },
    BufferLineInfo = { fg = p.color600, bg = p.color800 },
    BufferLineWarning = { fg = p.color600, bg = p.color800 },
    BufferLineDuplicate = { fg = p.color600, bg = p.color800 },
    BufferLineError = { fg = p.color600, bg = p.color800 },
    BufferLineIndicatorSelected = { fg = p.teal1, bg = p.color700 },
    BufferLineInfoDiagnosticSelected = { fg = p.teal1, bg = p.color700 },
    BufferLineWarningDiagnosticSelected = { fg = p.warning, bg = p.color700 },
    BufferLineErrorDiagnosticSelected = { fg = p.error, bg = p.color700 },
    BufferLineModifiedSelected = { fg = p.color100, bg = p.color700 },
    BufferLineIndicatorVisible = { fg = p.teal1, bg = p.color700 },
    BufferLineInfoDiagnosticVisible = { fg = p.color600, bg = p.color800 },
    BufferLineWarningDiagnosticVisible = { fg = p.color600, bg = p.color800 },
    BufferLineErrorDiagnosticVisible = { fg = p.color600, bg = p.color800 },
    BufferLineModifiedVisible = { fg = p.color600, bg = p.color800 },
    BufferLineSeparator = { fg = p.color800 },
    BufferLineBufferSelected = { bg = p.color700, style = 'italic' },
    BufferLineMiniIconsGreenSelected = { fg = p.teal1, bg = p.color700 },
    ...
    CursorLine = { bg = p.color800 },
    CursorLineNr = { fg = p.color100 },
    ...
    Pmenu = { fg = p.warning, bg = p.color700 },
    PmenuSbar = { bg = p.colo700 },
    PmenuSel = { fg = p.color800, bg = p.primary },
    ...
    TabLineSel = { fg = p.teal1, bg = p.background1 },
    Title = { fg = p.text },
    ...
    Number = { fg = p.warning },          --   a number constant: 234, 0xff
    Boolean = { fg = p.primary },         --  a boolean constant: TRUE, false
    Float = { fg = p.warning },           --    a floating point constant: 2.3e10
